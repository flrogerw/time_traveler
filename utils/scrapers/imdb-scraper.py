...
IS_DEV_MODE = False
CDN_URL = 'https://ia800802.us.archive.org/2/items/01-rock-hudson/'
SHOW_NAME = 'McMillan_Wife'
SHOW_ID = 130
URL_CSV = "/Users/roger.williams/Desktop/file_to_do/mcmillian_and_wife.csv"
IMDB_URL = 'https://www.imdb.com/title/tt0066685/episodes/?season=1'
...
def main():
    ...
    with open(URL_CSV, newline='') as csvfile:
        ...
        for row in cvs_reader:
            link = f"{CDN_URL}{row[0].replace('/download','')}"
